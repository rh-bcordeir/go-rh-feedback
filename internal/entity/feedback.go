...
type Feedback struct {
	...
	HiringProcess   HiringProcess `gorm:"foreignKey:HiringProcessID" json:"-"`
...
func NewFeedback(interviewerID string, stageID, hiringProcessID uint, comments string, score int) *Feedback {
